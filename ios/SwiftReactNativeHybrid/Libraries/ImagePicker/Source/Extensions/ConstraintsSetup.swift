...
//      addConstraint(NSLayoutConstraint(item: retakeButton, attribute: attribute,
//        relatedBy: .equal, toItem: nil, attribute: .notAnAttribute,
//        multiplier: 1, constant: ImageStackView.Dimensions.imageSize))
    ...
    addConstraint(NSLayoutConstraint(item: retakeButton, attribute: .centerY,
      relatedBy: .equal, toItem: self, attribute: .centerY,
    ...
    addConstraint(NSLayoutConstraint(item: retakeButton, attribute: .centerX,
